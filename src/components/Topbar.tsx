...
export default function Topbar({
  ...
  return (
    ...
    >
      ...
      {/* ستون وسط: برند هدر - وسط‌چین بین دو طرف */}
      <div className="flex-1 flex items-center justify-center">
        <div className="flex flex-col items-center gap-0.5 text-center" dir="rtl" aria-hidden="true">
